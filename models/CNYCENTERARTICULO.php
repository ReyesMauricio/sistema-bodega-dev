...
/**
 * This is the model class for table "CNYCENTER.ARTICULO".
 *
 ...
 * @property string|null $AGENTE_RETENCION
 * @property string|null $U_AGRUPACION
 * @property string|null $U_CAT011
 */
class CNYCENTERARTICULO extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'CNYCENTER.ARTICULO';
    }

    /**
     * @return conexion a la base de datos de prueba que se encuentra en el servidor.
     */
    ...
    public function rules()
    {
        return [
            ...
            [['TIPO', 'ORIGEN_CORP', 'COSTO_FISCAL', 'COSTO_COMPARATIVO', 'CLASE_ABC', 'ACTIVO', 'USA_LOTES', 'OBLIGA_CUARENTENA', 'UTILIZADO_MANUFACT', 'USA_NUMEROS_SERIE', 'MODALIDAD_INV_FIS', 'TIPO_COD_BARRA_DET', 'TIPO_COD_BARRA_ALM', 'USA_REGLAS_LOCALES', 'PERECEDERO', 'TIPO_COSTO', 'ES_ENVASE', 'USA_CONTROL_ENVASE', 'UTILIZADO_EN_CONTRATOS', 'VALIDA_CANT_FASE_PY', 'OBLIGA_INCLUIR_FASE_PY', 'ES_IMPUESTO', 'CANASTA_BASICA', 'ES_OTRO_CARGO', 'SERVICIO_MEDICO', 'CALC_PERCEP', 'SUGIERE_MIN', 'TIPO_VENTA', 'ES_INAFECTO', 'U_CAT011'], 'string', 'max' => 1],
            [['ARTICULO_DEL_PROV'], 'string', 'max' => 30],
            [['USUARIO_CREACION', 'USUARIO_ULT_MODIF', 'CODIGO_HACIENDA', 'TIENDA', 'CreatedBy', 'UpdatedBy', 'U_AGRUPACION'], 'string', 'max' => 50],
            ...
            [['AGENTE_RETENCION'], 'string', 'max' => 10],
            [['RowPointer'], 'unique'],
            [['ARTICULO'], 'unique'],
        ];
    }
