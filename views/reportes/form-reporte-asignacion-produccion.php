...
$this->title = 'Codigos asignados a mesas de produccion';
            ...
            <div class="row">
                ...
                <div class="col-md-12 mt-2">
                    ...
                    <?= Html::button('<i class="fa fa-plus"></i> Generar reporte', [
                        'value' => Url::to('index.php?r=reportes/crear-reporte-asignacion-produccion'),
                        'class' => 'btn btn-warning',
                        'id' => 'modalButton',
                    ]) ?>
                    <?= Html::a('<i class="fas fa-redo">&nbsp;&nbsp;Reiniciar</i>', ['reporte-asignacion-produccion'], [
