...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-briefcase"></i> &nbsp;Produccion por persona</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-12 mt-2">
                    ...
                    <?= Html::button('<i class="fa fa-plus"></i> Generar reporte', [
                        'value' => Url::to('index.php?r=reportes/crear-reporte-produccion-persona'),
                        //'value' => Url::to('index.php?r=reportes/crear-reporte-codigo-barra&codigoBarra=PU071119623'),
                        'class' => 'btn btn-warning',
                        'id' => 'modalButton',
                    ]) ?>
                    <?= Html::a('<i class="fas fa-redo">&nbsp;&nbsp;Reiniciar</i>', ['reporte-produccion-persona'], [
