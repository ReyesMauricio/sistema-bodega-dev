    ...
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-header d-flex justify-content-between">
                <h3 id="asignacion-report" class="card-title"><i class="fas fa-briefcase"></i> &nbsp;Asignacion de codigos - <?= $fechaInicio . " - " . $fechaFin ?> (<?= date("F j, Y", strtotime($fechaInicio)) . " - " . date("F j, Y", strtotime($fechaFin))?>)</h3>
                </h3>
            </div>
