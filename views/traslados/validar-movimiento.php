...
$this->title = 'Validacion de despacho';
...
<div class="card card-primary">
    ...
    <div class="card-body">
        <form role="form">
            <div class="row">
                <div class="col-md-4">
                    <label for="">Seleccione el tipo de movimiento: </label>
                    <?php echo Select2::widget([
                        'name' => 'empresa',
                        'id' => 'empresa',
                        'data' =>
                        ArrayHelper::map([
                            ['clave' => 'CA', 'empresa' => 'CARISMA'],
                            ['clave' => 'E0', 'empresa' => 'EVER'],
                            ['clave' => 'N0', 'empresa' => 'NERY'],
                            ['clave' => 'T0', 'empresa' => 'CANNYSHOP']
                        ], "clave", "empresa"),
                        'value' => 'CA',
                        'language' => 'es',
                ...
                <div class="col-md-12 mt-2">
                    <br>
                    <?= Html::button('<i class="fa fa-info"></i> Mostrar resumen', [
                        'value' => Url::to('index.php?r=traslados/ver-resumen-movimiento'),
                        'class' => 'btn btn-warning',
                        'id' => 'modalButton',
                    ]) ?>
                    <?= Html::a('<i class="fas fa-redo">&nbsp;&nbsp;Reiniciar</i>', ['validar-movimiento'], [
...
<script>
    ...
    botonModal.value += `&fechaInicio=${fechaInicio.value}&fechaFin=${fechaFin.value}&empresa=${empresa.value}`;

    $('#fechaInicio').on('change', function(e) {
        botonModal.value = ''
        botonModal.value += `${hrefBase}&fechaInicio=${fechaInicio.value}&fechaFin=${fechaFin.value}&empresa=${empresa.value}`;
    })
